...
export type TQuery = DocumentNode | TypedDocumentNode<any, OperationVariables>;
...
export type TQuerySeasonVariables = {
  type: TAnimeType;
  season: TAnimeSeason;
  seasonYear: number;
  perPage?: number;
...
export type TQueryDetailVariables = {
  type: TAnimeType;
  id: string;
};
...
const AnimeQueries = {
  ...
  `,
  season: gql`
    query ($season: MediaSeason, $seasonYear: Int, $page: Int = 1, $perPage: Int = 12) {
